...
--
-- Host: localhost    Database: cafeteria_chcl
-- ------------------------------------------------------
...
CREATE TABLE `clients` (
  ...
  `nom_client` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_client` enum('etudiant','professeur','personnel_admin','invite') COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_client` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'0001_01_01_000001_create_cache_table',1),(3,'0001_01_01_000002_create_jobs_table',1),(4,'2025_08_16_115918_create_plats_table',1),(5,'2025_08_16_115931_create_clients_table',1),(6,'2025_08_16_115947_create_ventes_table',1);
...
CREATE TABLE `plats` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nom_plat` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cuisson_plat` enum('cru','cuit','grille') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'Ventoy','jonasclocin01@gmail.com',NULL,'$2y$12$yUahjqFWkka5rQjCLVgtsOFHIixHA2lVr69XHwmflTNGWV1Xy.9nC','admin',NULL,'2025-08-17 05:07:44','2025-09-09 01:55:49'),(6,'Jonas CLOCIN','ventoy1605@gmail.co',NULL,'$2y$12$11BHtASjZc2eE5aMAUlTGulBIY1VOHgxHc.LiaDlQ0KRBZpsYggbS','user',NULL,'2025-09-09 00:46:21','2025-09-15 03:56:16'),(7,'Test','ventoy1605@gmail.com',NULL,'$2y$12$fHzocj/vHoalp49OZNPBbeySAR1JsRhq0RR/WuZIBA56QAd8knGXG','user',NULL,'2025-09-09 21:07:37','2025-09-15 03:54:15');
...
CREATE TABLE `ventes` (
  ...
  KEY `ventes_plat_id_foreign` (`plat_id`),
