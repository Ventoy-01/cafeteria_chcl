...
<head>
    ...
    <style>
        ...
        table th {
            background: rgb(144, 117, 48);
            color: white;
            text-transform: uppercase;
        }

        table td {
            color: rgba(76, 64, 49, 0.73);
            font-size: 14px;
        }
...
<h5>Rapport de vente du <span
        style="color:red;">{{ \Carbon\Carbon::parse($date_deb)->translatedFormat('l d F Y') }}</span>
...
<table class="table1">
    ...
    @empty
        <tr>
            <td colspan="5">Aucune vente trouvée pour cette période.</td>
        </tr>
    @endforelse
    </tbody>
</table>
